...
function minErr(module) {
  return function () {
    ...
    message = message + '\nhttp://errors.angularjs.org/1.2.10-build.local+sha.79e519f/' +
      (module ? module + '/' : '') + code;
 ...
 */
var version = {
  full: '1.2.10-build.local+sha.79e519f',    // all of these placeholder strings will be replaced by grunt's
